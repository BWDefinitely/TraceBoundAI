import { listReflections, listStories } from "../../lib/store";
...
export default async function ReflectPage({
  ...
  const [sp, stories, reflections] = await Promise.all([
    searchParams,
    listStories(),
    listReflections(),
  ]);
  ...
  return (
    <div className="fade-in">
      ...
      />
      <ReflectForm stories={stories} reflections={reflections} initialStoryId={initial} />
    </div>
  );
}
